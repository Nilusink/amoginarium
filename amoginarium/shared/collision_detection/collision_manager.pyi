...
class CollisionManager:
    ...
    def create_relation(self, group_a_id: int, group_b_id: int, cb_a_on_start: CollisionCallback | None = None,
                        ...
                        cb_b_on_end: CollisionCallback | None = None) -> int: ...
    ...
    def manual_collision(self, group_ids: list[int], start_position: Vec2, end_position: Vec2, size: Vec2 | None = None,
                         hitbox_type: str = "point", centered: bool = False, rotation: float = 0.0,
                         start_positions: list[Vec2] | None = None, radius: float | None = None,
                         ignore_collisions: int | list[int] | None = None) -> list[CollisionEvent]: ...
