...
class PlayerLike(VisibleGameEntityLike, Protocol):
    @classmethod
    def load_textures(cls) -> None: ...
...
# class ItemLike(BaseItemLike, Protocol):
#     def use(self) -> None: ...
...
class ItemLike(VisibleGameEntityLike, Protocol):
    def hide(self) -> None: ...

    def show(self) -> None: ...

    def hit(self, hit_by=...) -> None: ...
